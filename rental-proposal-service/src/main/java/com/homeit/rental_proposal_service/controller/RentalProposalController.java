package com.homeit.rental_proposal_service.controller;

import com.homeit.rental_proposal_service.dtos.RentalProposalDTO;
import com.homeit.rental_proposal_service.entities.Round;
import com.homeit.rental_proposal_service.service.RentalProposalService;
...
public class RentalProposalController {
    private final RentalProposalService service;

    public RentalProposalController(RentalProposalService rentalProposalService) {
        this.service = rentalProposalService;
    }
